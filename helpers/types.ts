...
export interface INervosConfig {
  MarketId: string;
  ATokenNamePrefix: string;
  StableDebtTokenNamePrefix: string;
  VariableDebtTokenNamePrefix: string;
  SymbolPrefix: string;
  ProviderId: number;
  ProviderRegistry: tEthereumAddress;
  ProviderRegistryOwner: tEthereumAddress;
  LendingPoolCollateralManager: tEthereumAddress;
  LendingPoolConfigurator: tEthereumAddress;
  LendingPool: tEthereumAddress;
  LendingRateOracle: tEthereumAddress;
  TokenDistributor: tEthereumAddress;
  AaveOracle: tEthereumAddress;
  ChainlinkAggregator: ITokenAddress;
  FallbackOracle: tEthereumAddress;
  PoolAdminIndex: number;
  ReserveAssets: SymbolMap<tEthereumAddress>;
  PoolAdmin?: tEthereumAddress;
  EmergencyAdmin?: tEthereumAddress;
  EmergencyAdminIndex: number;
  ProtocolGlobalParams: any;
  LendingRateOracleRatesCommon: iMultiPoolsAssets<IMarketRates>;
  ReservesConfig: iMultiPoolsAssets<IReserveParams>;
  ...
  WrappedNativeToken: tEthereumAddress;
