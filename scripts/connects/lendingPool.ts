...
export function connectLendingPool(address: string, deployer: Deployer) {
  const contract = new ethers.Contract(address, LendingPool_JSON.abi, deployer).connect(
    deployer
  ) as LendingPool;
...
export function connectLendingPoolRegistry(address: string, deployer: Deployer) {
  const contract = new ethers.Contract(address, Registry_JSON.abi, deployer).connect(
    deployer
...
export function connectLendingPoolAddressProvider(address: string, deployer: Deployer) {
  const contract = new ethers.Contract(address, AddressProvider_JSON.abi, deployer).connect(
    deployer
...
export function connectLendingPoolConfigurator(address: string, deployer: Deployer) {
  const contract = new ethers.Contract(address, Configurator_JSON.abi, deployer).connect(
    deployer
