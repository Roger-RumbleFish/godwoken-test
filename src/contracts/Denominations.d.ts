...
interface DenominationsInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "CKB", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "CKB", data: BytesLike): Result;
...
export class Denominations extends BaseContract {
  ...
  functions: {
    ...
    CKB(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    CKB(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    CKB(overrides?: CallOverrides): Promise<PopulatedTransaction>;
